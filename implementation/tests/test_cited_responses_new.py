...
class CitedPromptTest(unittest.TestCase):
    ...
    def test_search_query_prompt_has_no_evidence_or_gold_and_ends_with_query_label(self):
        ...
        self.assertIn("Example query:", prompt)
    ...
    def test_cited_response_prompt_lists_sources_and_forbids_gold_urls_markup(self):
        ...
        self.assertIn("Worked format example:", prompt)
        self.assertIn("Answer: Mars", prompt)
        self.assertIn("Reasoning: The source identifies Mars as the Red Planet [S001].", prompt)
        self.assertIn("Sources: S001", prompt)
