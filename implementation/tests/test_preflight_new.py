...
class PreflightQualityTest(unittest.TestCase):
    ...
    def test_gate_rejects_structurally_broken_outputs(self):
        decision = assess_preflight({"nonempty_rate": 0.5, "copying_rate": 0.0, "truncation_rate": 0.0})
    ...
    def test_thinking_mode_selection_uses_accuracy_after_quality_gate(self):
        direct = {"exact_match": 0.25, "f1": 0.30, "nonempty_rate": 1.0, "copying_rate": 0.0, "truncation_rate": 0.0}
        two_pass = {"exact_match": 0.35, "f1": 0.40, "nonempty_rate": 1.0, "copying_rate": 0.0, "truncation_rate": 0.0}
