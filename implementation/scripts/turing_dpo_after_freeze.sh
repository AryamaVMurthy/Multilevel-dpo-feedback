...
required=(
  ...
  PROMPT_HASH RETRIEVAL_HASH SOURCE_SCHEMA_HASH OPTIMIZATION_DECISION OPTIMIZATION_DECISION_SHA256
  SCALE_DECISION SCALE_DECISION_SHA256 REF_LOG_PROBS EVAL_REF_LOG_PROBS REFERENCE_CHECKPOINT_HASH PROMPT_CONTEXT_SCHEMA
